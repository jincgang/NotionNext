...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '欢迎来到金昌的个人网站', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '我的笔记网站', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://hq207.dpdns.org', // 网站地址
